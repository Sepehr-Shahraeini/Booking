...
{
    public partial class drkh_databaseContext : DbContext
    {
        public drkh_databaseContext()
        {
        }

        public drkh_databaseContext(DbContextOptions<drkh_databaseContext> options)
            : base(options)
        {
        }
