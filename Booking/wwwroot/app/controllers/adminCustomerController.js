...
app.controller('adminCustomerController', ['$scope', '$routeParams', '$location', 'authService', 'ngAuthSettings', '$rootScope', 'orderService', '$http', 'Psychoanalyst', function ($scope, $routeParams, $location, authService, ngAuthSettings, $rootScope, orderService, $http, Psychoanalyst) {
    ...
    $scope.btn_savePsychoanalyst = function (e) {
        ...
        Psychoanalyst.newPsychoanalyst(dto_psychoanalyst).then(function (response) {
    ...
    $scope.btn_saveTime = function (e) {
        ...
        $scope.entity_VisitingTime.EndTime = $scope.EndTime_hour + ":" + $scope.EndTime_minute
          ...
          Psychoanalyst.newVisitingTime($scope.entity_VisitingTime).then(function (response) {
            alert("زمان ذخیره شد")
    ...
    $scope.btn_sat = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "6").then(function (response) {
    ...
    $scope.btn_sun = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "0").then(function (response) {
            $scope.ExistTime = response.data
        })
    ...
    $scope.btn_mon = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "1").then(function (response) {
            $scope.ExistTime = response.data
        })
    ...
    $scope.btn_tues = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "2").then(function (response) {
            $scope.ExistTime = response.data
        })
    ...
    $scope.btn_wend = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "3").then(function (response) {
            $scope.ExistTime = response.data
        })
    ...
    $scope.btn_thurs = function (e) {
        authService.visitingTimeByDrPhone($scope.newPsychoanalystId, "4").then(function (response) {
            $scope.ExistTime = response.data
        })
